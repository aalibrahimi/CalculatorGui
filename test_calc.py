...
class Page1(Page):
    ...
    def create_rounded_entry(self, style_name):
        frame = tk.Frame(self, bg="#3E3E3E", bd=0)
    ...
    def entries(self):
        ...
        self.prince_frame.grid(row=0, column=0, columnspan=4, padx=12, pady=10)
        self.king_frame.grid(row=1, column=0, columnspan=4, padx=12, pady=20)
    
    def buttonclick(self, number):
        self.expression += str(number)
        self.prince.insert(tk.END, str(number))
        self.king.insert(tk.END, str(number))
